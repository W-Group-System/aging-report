            ...
            <div class="upper-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 75px;text-align: center;">{{ number_format($vatable_amount, 2) }}</td>
                    </tr>
                    <tr>
                        <td style="width: 90px;"></td>
                        ...
                        <td style="width: 80px;"></td>
                        <td style="width: 60px;"></td>
                        <td style="width: 75px; padding:0;border-bottom: 1px double black; border-top:1 px solid black;text-align: center;">{{ number_format($total_amount_payable,2) }}</td>
                    </tr>
                    <tr>
                        <td></td>
