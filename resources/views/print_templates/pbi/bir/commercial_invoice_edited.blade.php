    ...
    {{-- <div class="left">
        <div class="header">
            ...
            <div class="text" style="float: right">
              ...
              <span class="header-small-text">Tel: (02) 8806-3838 / Fax (02) 8806-1033</span>
            </div>
              </div>
            </div>
        </div>
                            ...
                            <table style="width: 100%; border-collapse: collapse;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="label-column"></td>
                                        <td class="value-column" style="padding-top: 3px"> {{ $detail->Currency }} {{ (number_format($total,2)) }}</td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 10px !important;"></td>
                                        <td class="label-column" style="height: 15px !important;"></td>
                                        <td class="value-column" style="height: 15px !important;"></td>
                                    </tr>
                                    <tr>
                                      <td></td>
                                      <td></td>
