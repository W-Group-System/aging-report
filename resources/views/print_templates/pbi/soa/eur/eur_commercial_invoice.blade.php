...
<div class="header-container">
    <div class="left">
        <div class="header">
            ...
            <div class="line-three">No.: {{ optional($details->first())->SoaNo }}</div>
...
<div class="customer-container">
    <div class="left-column">
        <div class="info-row">
            ...
            <span class="info-value"><strong>{{ optional($details->first())->SoldTo }}</strong><br>{!! nl2br(e( optional($details->first())->Address)) !!}</span>
        </div>
        {{-- <div class="info-row">
        ...
        <tbody>
            ...
            {{-- <tr>
                ...
                <td colspan="2"  style="font-weight: bold; padding:0; text-align: center">{{ $details->first()->U_Delivery }}</td>
                    ...
                    <td></td>
                    <td></td>
                        {{-- @if ( optional($details->first())->Currency == 'EUR')
                        <td>ADD:21% VAT</td>
                        @else --}}
                        <td>ADD:21% VAT</td>
                        {{-- @endif --}}
...
<div class="product-total">
    <div class="total-left-column">
        ...
        <div class="info-row">
            <span class="info-name">VAT Amount</span>
            <span class="info-colon">:</span>
            <span class="info-detail">{{ optional($details->first())->Currency }} {{ number_format($vatable_amount, 2) }}</span>
        </div>
    </div>
