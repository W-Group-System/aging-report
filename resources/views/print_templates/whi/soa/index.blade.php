                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="d-flex align-items-center flex-wrap">
                                <form method="GET" action="{{ url('whi_soa_list') }}" class="form-inline d-flex align-items-center me-3">
                                   ...
                                   <tbody>
                                    @foreach ( $details as $detail)
                                        <tr>
                                            <td>
                                                @if ($detail->asNew)
                                                    <button onclick="" type="button" class="btn btn-primary btn-outline" title="Edit Invoice" data-toggle="modal" data-target="#soaCommercialEdited{{ $detail->asNew->id }}" ><i class="fa fa fa-pencil"></i></button>
                                                    @if ($detail->asNew->Type == 'zero_rated')
                                                        <a target='_blank' href="{{ url('whi_usa_soa', $detail->asNew->id) }}" class="btn btn-danger btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @elseif ($detail->asNew->Type == 'vatable')
                                                        <a target='_blank' href="{{ url('whi_usa_soa', $detail->asNew->id) }}" class="btn btn-success btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @else
                                                ...
                                                @else
                                                    <button onclick="" type="button" class="btn btn-primary btn-outline" title="Edit Invoice" data-toggle="modal" data-target="#soaCommercialEdit{{ $detail->DocEntry }}" ><i class="fa fa fa-plus"></i></button>
                                                @endif
                                            </td>
                                            <td>
                                                @if ($detail->asNew)
                                                    @if ($detail->asNew->Type == 'zero_rated')
                                                        <a target='_blank' href="{{ url('whi_eur_soa', $detail->asNew->id) }}" class="btn btn-danger btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @elseif ($detail->asNew->Type == 'vatable')
                                                        <a target='_blank' href="{{ url('whi_eur_soa', $detail->asNew->id) }}" class="btn btn-success btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @else
                                                        <a target='_blank' href="{{ url('whi_eur_soa', $detail->asNew->id) }}" class="btn btn-info btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @endif
                                                @endif
                                            </td>
                                            <td>
                                                @if ($detail->asNew)
                                                    @if ($detail->asNew->Type == 'zero_rated')
                                                        <a target='_blank' href="{{ url('whi_php_soa', $detail->asNew->id) }}" class="btn btn-danger btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @elseif ($detail->asNew->Type == 'vatable')
                                                        <a target='_blank' href="{{ url('whi_php_soa', $detail->asNew->id) }}" class="btn btn-success btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @else
                                                        <a target='_blank' href="{{ url('whi_php_soa', $detail->asNew->id) }}" class="btn btn-info btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                    @endif
                                                @endif
                                            </td>           
