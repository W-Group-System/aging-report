@if ( $detail->asNew)
<div class="modal fade" id="soaCommercialEdited{{ $detail->asNew->id }}" tabindex="-1" aria-labelledby="soaCommercialEditLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <label >Sold To:</label>
                    <textarea name="Client" rows="3" class="form-control" type="text">{{ $detail->asNew->SoldTo }}</textarea>
                </div>
                <div class="col-md-6">
                    <label >Address:</label>
                ...
                <div class="col-md-3">
                    ...
                    <input class="form-control" name="PackingUom" type="text" value="{{ $detail->asNew->Uom }}">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input name="PickupDate" class="form-control" type="date" value="{{ \Carbon\Carbon::parse(optional($detail->asNew)->PickupDate)->format('Y-m-d') }}">
                </div>
                <div class="col-md-3">
                ...
                {{-- <div class="col-md-4">
                    <label>Sales Contract No.</label>
                    <input name="SalesContract" class="form-control" type="text" value="{{ $detail->asNew->U_Salescontract }}">
                </div>  --}}
            </div>  
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input name="DateOfShipment" class="form-control" type="date" value="{{ \Carbon\Carbon::parse(optional($detail->asNew)->DocDueDate)->format('Y-m-d') }}">
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input name="FeederVessel" class="form-control" type="text" value="{{ $detail->asNew->FeederVessel }}">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input name="AirwayBillNo" class="form-control" type="text" value="{{ $detail->asNew->AirwayBillNo }}">
                </div>
                <div class="col-md-3">
