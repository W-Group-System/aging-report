            ...
            <div class="card">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="GET" action="{{ url('ccc_bir_invoice') }}" class="form-inline" style="margin-bottom: 15px;">
                                   ...
                                   <tbody>
                                    @foreach ( $details as $detail)
                                        <tr>
                                            <td>
                                                @if ($detail->asNew)
                                                    <button onclick="" type="button" class="btn btn-primary btn-outline" title="Edit Invoice" data-toggle="modal" data-target="#CccBirCommercialEditNew{{ $detail->asNew->id }}" ><i class="fa fa fa-pencil"></i></button>
                                            ...
                                            {{-- <td>
                                                @if ($detail->asNew)
                                                <a target='_blank' href="{{ url('bir_edited_commercial_invoice', $detail->asNew->DocNum) }}" class="btn btn-warning btn-outline" > <i class="fa fa-sharp fa-print"></i></a>
                                                @endif
                                                <a target='_blank' href="{{ url('bir_original_commercial_vatable_invoice', $detail->DocNum) }}" class="btn btn-danger btn-outline" > <i class="fa fa-solid fa-print"></i></a>
                                            </td>         --}}
